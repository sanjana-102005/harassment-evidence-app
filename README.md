...
Version Control: Git + GitHub
Project Structure
harassment_evidence_app/ │ ├── app/ │ ├── streamlit_app.py │ ├── models/ │ └── utils/ │ ├── ml_predictor.py │ ├── harassment_rules.py │ ├── india_laws.py │ └── pdf_generator.py │ ├── data/ │ └── train.csv │ ├── model_training/ │ └── train_model.py │ └── requirements.txt
